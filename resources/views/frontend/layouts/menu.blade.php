                                            ...
                                            <li>
                                                ...
                                                @if (count($subCategory->childCategories) > 0)
                                                    <ul class="wsus__sub_category">
                                                        @foreach ($subCategory->childCategories as $childCategroy)
                                                            <li>
                                                                <a href="#">
                                                                    {{ $childCategroy->name }}
                                                                </a>
            ...
            <div class="wsus__mobile_menu_main_menu">
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <ul class="wsus_mobile_menu_category">
                        @foreach ($categories as $category)
                            <li>
                                <a href="#" {!! count($category->subCategories) > 0
                                    ? "class='accordion-button collapsed' data-bs-toggle='collapse' data-bs-target='#flush-collapseThreew-$loop->index' aria-expanded='false' aria-controls='flush-collapseThreew-$loop->index'"
                                    : '' !!}>
                                    <i class="{{ $category->icon }}"></i>
                                    {{ $category->name }}
                                </a>
